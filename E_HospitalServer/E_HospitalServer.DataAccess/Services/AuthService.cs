    ...
    JwtProvider jwtProvider) : IAuthService
{
    ...
    public async Task<Result<LoginResponseDto>> GetTokeByRefreshToken(string refreshToken,
    ...
    public async Task<Result<string>> ConfirmVerificationEmail(int emailConfirmCode,
        CancellationToken cancellationToken)
    {
